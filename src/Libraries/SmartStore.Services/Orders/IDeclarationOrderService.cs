...
namespace SmartStore.Services.Orders
{
    ...
    /// </summary>
    public partial interface IDeclarationOrderService
    {
        #region Orders
        ...
        DeclarationOrder GetOrderById(int orderId);
        ...
        /// </param>
        /// <returns>Order</returns>
        DeclarationOrder GetOrderByNumber(string orderNumber);
        ...
        /// <returns>Order</returns>
        IList<DeclarationOrder> GetOrdersByIds(int[] orderIds);
        ...
        /// <returns>Order</returns>
        DeclarationOrder GetOrderByGuid(Guid orderGuid);
        ...
        DeclarationOrder GetOrderByPaymentAuthorization(string paymentMethodSystemName, string authorizationTransactionId);
        ...
        /// <returns>Order entity</returns>
        DeclarationOrder GetOrderByPaymentCapture(string paymentMethodSystemName, string captureTransactionId);

        /// <summary>
        /// Deletes an order
        /// </summary>
        /// <param name="order">The order</param>
        void DeleteOrder(DeclarationOrder order);
		...
		IQueryable<DeclarationOrder> GetOrders(
			int storeId,
			int customerId,
			DateTime? startTime,
			DateTime? endTime,
		...
		IPagedList<DeclarationOrder> SearchOrders(int storeId, int customerId, DateTime? startTime, DateTime? endTime,
        ...
        /// <param name="affiliateId">Affiliate identifier</param>
        /// <returns>Order collection</returns>
        IList<DeclarationOrder> GetOrdersByAffiliateId(int affiliateId);
        ...
        /// </summary>
        /// <param name="order">The order</param>
        void UpdateOrder(DeclarationOrder order);
		...
		void AddOrderNote(DeclarationOrder order, string note, bool displayToCustomer = false);
