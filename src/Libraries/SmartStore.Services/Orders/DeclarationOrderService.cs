...
{
    public partial class DeclarationOrderService : IDeclarationOrderService
    {
        private readonly IRepository<DeclarationOrder> _orderRepository;
        ...
        public virtual DeclarationOrder GetOrderById(int orderId)
        {
            if (orderId == 0)
                return null;
        ...
        public virtual IList<DeclarationOrder> GetOrdersByIds(int[] orderIds)
        {
            if (orderIds == null || orderIds.Length == 0)
                return new List<DeclarationOrder>();
        ...
        public virtual DeclarationOrder GetOrderByNumber(string orderNumber)
        {
        ...
        public virtual DeclarationOrder GetOrderByGuid(Guid orderGuid)
        {
		...
		public virtual DeclarationOrder GetOrderByPaymentAuthorization(string paymentMethodSystemName, string authorizationTransactionId)
		{
		...
		public virtual DeclarationOrder GetOrderByPaymentCapture(string paymentMethodSystemName, string captureTransactionId)
		{
		...
		public virtual IQueryable<DeclarationOrder> GetOrders(
			int storeId,
			int customerId,
			DateTime? startTime,
			DateTime? endTime,
		...
		public virtual IPagedList<DeclarationOrder> SearchOrders(int storeId, int customerId, DateTime? startTime, DateTime? endTime, 
        ...
        public virtual IList<DeclarationOrder> GetOrdersByAffiliateId(int affiliateId)
        {
            var query = from o in _orderRepository.Table
        ...
        public virtual void InsertOrder(DeclarationOrder order)
        {
            if (order == null)
        ...
        {
           return _orderRepository.Table.Max(x=>x.Id)??0;
        }
		...
		public virtual void DeleteOrder(DeclarationOrder order)
		{
			if (order == null)
				throw new ArgumentNullException("order");
        ...
        public virtual DeclarationOrder GetOrderByAuthorizationTransactionIdAndPaymentMethod(string authorizationTransactionId, string paymentMethodSystemName)
        { 
            var query = _orderRepository.Table;
		...
		public virtual void AddOrderNote(DeclarationOrder order, string note, bool displayToCustomer = false)
		{
