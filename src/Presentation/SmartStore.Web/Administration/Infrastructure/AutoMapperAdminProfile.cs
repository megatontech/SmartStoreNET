...
namespace SmartStore.Admin.Infrastructure
{
    ...
    {
        private class OptionalFkConverter : ITypeConverter<int?, int?>, ITypeConverter<int, int?>
        {
...
#pragma warning restore 612, 618
                .ForMember(dest => dest.AppliedDiscounts, mo => mo.Ignore());
            //products
            CreateMap<DeclarationProduct, DeclarationProductModel>()
            ...
            CreateMap<DeclarationProductModel, DeclarationProduct>()
