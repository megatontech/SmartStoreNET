...
namespace SmartStore.Core.Domain.Catalog
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeclarationProduct : BaseEntity, IAuditable, ISoftDeletable, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IMergedData
    {
        #region static
