...
{
	[Validator(typeof(DeclarationProductValidator))]
    public class DeclarationProductModel : TabbableModel, ILocalizedModel<ProductLocalizedModel>, IStoreSelector, IAclSelector
	{
        public DeclarationProductModel()
        {
    ...
    public class DeclarationProductLocalizedModel : ILocalizedModelLocal
    {
        public int LanguageId { get; set; }
	...
	public partial class DeclarationProductValidator : AbstractValidator<DeclarationProductModel>
	{
		public DeclarationProductValidator(Localizer T)
		{
	...
	public partial class DeclarationProductVariantAttributeValueModelValidator : AbstractValidator<DeclarationProductModel.ProductVariantAttributeValueModel>
	{
		public DeclarationProductVariantAttributeValueModelValidator()
		{
			RuleFor(x => x.Name).NotEmpty();
